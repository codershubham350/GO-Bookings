...
import (
	...
	"github.com/codershubham350/bookings/internal/driver"
	"github.com/codershubham350/bookings/internal/forms"
	...
	"github.com/codershubham350/bookings/internal/repository"
	"github.com/codershubham350/bookings/internal/repository/dbrepo"
...
// NewTestRepo creates the new repository
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	// 2022-10-11 -- 01/02 03:04:05PM '06 -0700
	// layout := "2006-01-02"
	...
	// send Notifications- to the property owner
	htmlMessage = fmt.Sprintf(`
...
// BookRoom takes URL parameters, builds a sessional varable and take user to make res screen
...
func (m *Repository) AdminPostReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	for _, x := range rooms {
		// Get the block map from session. Loop through entire map , if we have an entry  in the map
		// that does not exist in out posted data, and if our restriction id > 0 then it is a block we
		// need to remove.
